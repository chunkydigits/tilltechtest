...
namespace PriceCalculator.Tests.Repositories
{
    public class OfferRepositoryTests
    {
        ...
        [Fact]
        public void
            When_a_basket_is_submitted_with_two_qualifying_items__Then_total_is_correct_with_both_percentage_reduction_offers_applied()
        {
        }

        [Fact]
        public void
            When_a_basket_is_submitted_with_qualifying_trigger_items__The_total_is_correct_when_multiple_different_offers_apply()
        {
        }
        ...
        [Fact]
        public void
            When_a_basket_is_submitted_with_a_trigger_item_that_does_not_meet_multibuy_offer_criteria__And_a_multibuy_offer_applies__Then_no_offers_are_applied()
        {
        }

        [Fact]
        public void
            When_a_basket_is_submitted_with_trigger_items_that_meet_multibuy_offer_criteria__And_a_multibuy_offer_applies__Then_the_correct_multibuy_offer_is_applied()
        {
        }

        [Fact]
        public void
            When_a_basket_is_submitted_with_trigger_items_that_meets_an_out_of_date_offer__Then_the_offer_is_NOT_applied()
        {
        }
    }
}