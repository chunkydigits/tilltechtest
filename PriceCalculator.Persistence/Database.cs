...
namespace Persistence
{
    ...
    public class Database : IDatabase
    {
        ...
        private static decimal TenPercentOffApples(List<CheckoutItem> items)
        {
            return items.Where(o => o.Name == "apples").Sum(o => o.Cost) / 10;
        }

        private static decimal BeansOnToastSpecialDeal(List<CheckoutItem> items)
        {
            var numberOfBeans = items.Count(o => o.Name == "beans");
            var numberOfBread = items.Count(o => o.Name == "bread");

            var qualifyingBeansAndToastOffers = numberOfBeans / 2;
            if (numberOfBeans % 2 != 0) qualifyingBeansAndToastOffers = (numberOfBeans - 1) / 2;
